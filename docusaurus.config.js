...
const config = {
  title: 'ArknightSStory Side',
  tagline: '一个收集鹰角原神剧情的地方',
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/Lemon-miaow/ArknightSStory',
            label: 'GitHub',
            position: 'right',
          },
        ],
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Lemon_miaow, Inc. Built with Docusaurus.`,
      },
      prism: {
